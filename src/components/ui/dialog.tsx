...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-4xl font-serif text-muted-foreground", className)}
      {...props}
    />
  )
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-muted-foreground text-base font-sans", className)}
      {...props}
    />
  )
}
